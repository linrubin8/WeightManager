...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(117,38,'ItemPrice_Synchornous','销售价格同步',0,0,null,0,0,0)
set IDENTITY_INSERT dbpermissiondata off
