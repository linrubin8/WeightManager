...
AS
SELECT     i.SaleCarInBillID, i.BillTypeID, o.SaleCarOutBillCode, i.SaleCarInBillCode, i.CarID, c.CarNum, i.ItemID, b.ItemName, b.ItemRate, b.ItemMode, i.BillDate AS BillDateIn, 
                      i.ReceiveType, ISNULL(i.BillStatus, 0) AS BillStatus, i.CustomerID, s.CustomerName, i.CalculateType, i.CarTare, i.PrintCount, i.IsCancel, i.ApproveBy, i.ApproveTime, 
                      ...
                      i.SynchronousToServerTime, s.AmountType, o.CreateTime, o.MaterialPrice, o.FarePrice, o.TaxPrice, o.BrokerPrice, o.ChangeDetail, i.IsSynchronousToK3OutBill, 
                      i.SynchronousK3ByOutBill, i.SynchronousToTimeOutBill, i.SynchronousK3OutBillResult, i.IsSynchronousToK3Receive, i.SynchronousK3ByReceive, 
                      i.SynchronousToTimeReceive, i.SynchronousK3ReceiveResult, b.K3ItemCode, s.K3CustomerCode, t.CustomerTypeID, t.CustomerTypeName
FROM         dbo.SaleCarInBill AS i INNER JOIN
                      ...
                      dbo.DbItemType AS y ON y.ItemTypeID = b.ItemTypeID LEFT OUTER JOIN
                      dbo.DbCustomerType AS t ON t.CustomerTypeID = s.CustomerTypeID
