...
begin
    set IDENTITY_INSERT dbpermission on
insert dbpermission (PermissionID,PermissionName,ParentPermissionID,Forbid ) values(42,'同步磅单至K3应收单',32,null)
set IDENTITY_INSERT dbpermission off
...
begin
    set IDENTITY_INSERT dbpermission on
insert dbpermission (PermissionID,PermissionName,ParentPermissionID,Forbid ) values(43,'同步磅单至K3出库单',32,null)
set IDENTITY_INSERT dbpermission off
...
begin
    set IDENTITY_INSERT dbpermission on
insert dbpermission (PermissionID,PermissionName,ParentPermissionID,Forbid ) values(45,'客户类型管理',25,null)
set IDENTITY_INSERT dbpermission off
...
begin
    set IDENTITY_INSERT dbpermission on
insert dbpermission (PermissionID,PermissionName,ParentPermissionID,Forbid ) values(46,'在线记录管理',5,null)
set IDENTITY_INSERT dbpermission off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(114,38,'Customer_Synchornous','客户资料同步',0,0,null,0,0,1)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(115,38,'Car_Synchornous','车辆资料同步',0,0,null,0,0,1)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(116,38,'SalesBill_Synchornous','单据信息同步至服务器',0,0,null,0,0,0)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(117,38,'ItemPrice_Synchornous','销售价格同步',0,0,null,0,0,1)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(119,42,'SalesManagerSynK3Receive','同步磅单至K3应收单',1,0,null,0,0,0)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(120,43,'SaleInOutSynK3OutBill','同步磅单至K3出库单',1,0,null,0,0,0)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(121,38,'BaseInfo_Synchornous','同步到本地(客户、车辆、单价)',0,0,null,null,null,null)
set IDENTITY_INSERT dbpermissiondata off
...
PermissionDataName='同步到本地(客户、车辆、单价)',
PermissionType=0,
PermissionSPType=0,
LogFieldName='',
PermissionViewType=null,
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(122,33,'SalesManager_DeleteBill','删除选中榜单',0,14125,null,0,0,0)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(123,45,'DBCustomerType_Query','客户类型查询',1,0,'',139,0,0)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(126,45,'DBCustomerType_Add','客户类型_添加',0,14800,null,0,1,0)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(127,45,'DBCustomerType_Update','客户类型_编辑',0,14801,null,0,2,0)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(128,45,'DBCustomerType_Delete','客户类型_删除',0,14802,null,0,3,0)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(129,46,'OnLineManager_Query','在线记录管理_查询',1,0,null,140,0,0)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(130,46,'SysSession_Delete','删除记录',0,30002,null,0,1,0)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    set IDENTITY_INSERT dbsysconfigfield on
insert dbsysconfigfield (SysConfigFieldID,SysConfigFieldName,SysConfigFieldText,SysConfigDataType,SysConfigDefaultValue ) values(18,'PriceSynchronousTime','单价资料同步',0,null)
set IDENTITY_INSERT dbsysconfigfield off
