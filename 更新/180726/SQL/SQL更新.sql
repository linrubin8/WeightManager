...
begin
    set IDENTITY_INSERT dbpermission on
insert dbpermission (PermissionID,PermissionName,ParentPermissionID,Forbid ) values(42,'同步磅单至K3',32,null)
set IDENTITY_INSERT dbpermission off
...
begin
    set IDENTITY_INSERT dbpermissiondata on
insert dbpermissiondata (PermissionDataID,PermissionID,PermissionCode,PermissionDataName,PermissionType,PermissionSPType,LogFieldName,PermissionViewType,DetailIndex,Forbid ) values(119,42,'SalesManagerSynK3','同步磅单至K3',1,0,null,null,null,null)
set IDENTITY_INSERT dbpermissiondata off
...
begin
    update DbPermissionData
    set PermissionID=42,
PermissionCode='SalesManagerSynK3',
PermissionDataName='同步磅单至K3',
PermissionType=1,
PermissionSPType=0,
LogFieldName='',
PermissionViewType=null,
