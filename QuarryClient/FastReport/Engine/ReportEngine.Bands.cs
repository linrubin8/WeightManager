    ...
    internal bool CanPrint(ReportComponentBase obj)
    {
      ...
      if (isLastPage)
      {
        if ((obj.PrintOn & PrintOn.LastPage) == 0)
          canPrint = false;
        if (obj.PrintOn == PrintOn.LastPage || obj.PrintOn == (PrintOn.LastPage | PrintOn.SinglePage) || obj.PrintOn == (PrintOn.FirstPage | PrintOn.LastPage))
          canPrint = true;
      }
      if (isFirstPage)
      {
        if ((obj.PrintOn & PrintOn.FirstPage) == 0)
          canPrint = false;
        if (obj.PrintOn == PrintOn.FirstPage || obj.PrintOn == (PrintOn.FirstPage | PrintOn.SinglePage) || obj.PrintOn == (PrintOn.FirstPage | PrintOn.LastPage))
          canPrint = true;
      }
