...
namespace FastReport.Gauge.Simple
{
    ...
    public class SimpleScale : GaugeScale
    {
        ...
        /// </summary>
        [Browsable(true)]
        public SimpleSubScale FirstSubScale
        {
        ...
        /// </summary>
        [Browsable(true)]
        public SimpleSubScale SecondSubScale
        {
        ...
        private void DrawMajorTicksHorz(FRPaintEventArgs e)
        {
            ...
            Brush brush = e.Cache.GetBrush(Color.Black);
            float x = left;
            float y1 = top;
            float y2 = top + height / 2 - 6 * e.ScaleY;
            float y3 = top + height / 2 + 6 * e.ScaleY;
            float y4 = top + height;
        ...
        private void DrawMajorTicksVert(FRPaintEventArgs e)
        {
            ...
            float y = top + height;
            float x1 = left;
            float x2 = left + width / 2 - 6 * e.ScaleX;
            float x3 = left + width / 2 + 6 * e.ScaleX;
            float x4 = left + width;
