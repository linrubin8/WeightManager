...
namespace FastReport.TypeEditors
{
  ...
  /// </summary>
  public class ReportComponentRefEditor : UITypeEditor
  {
      ...
      IServiceProvider provider, object Value)
    {
      ...
      if (context != null && context.Instance != null)
      {
        ...
        lb.PopulateList((context.Instance as ComponentBase).Report, context.PropertyDescriptor.PropertyType, null);
        if (Value != null)
