...
namespace FastReport.Data
{
  ...
  {
    private List<FilterElement> FElements;
    ...
    {
      foreach (FilterElement element in FElements)
      {
        bool match = false;
    ...
    {
      FElements = new List<FilterElement>();
    }
    ...
    internal class FilterElement
    {
      ...
      private FilterOperation FOperation;
      private SortedList<string,object> FSortedList;
      ...
      public FilterElement(object value, FilterOperation operation)
      {
        ...
        if (value is string[])
        {
          FSortedList = new SortedList<string,object>();
          foreach (string s in (string[])value)
          {
            if (!FSortedList.ContainsKey(s))
              FSortedList.Add(s, null);
          }
        }  
      }
    }
