...
namespace FastReport.Export.Image
{
    ...
    public class ImageExport : ExportBase
    {
        ...
        private int FPaddingNonSeparatePages = 10;
        ...
        private System.Drawing.Drawing2D.GraphicsState state = null;
        ...
        {
            get { return FPaddingNonSeparatePages; }
            set { FPaddingNonSeparatePages = value; }
        }
        ...
        protected override void ExportPageBegin(ReportPage page)
        {
            ...
            fileSuffix = FFirstPage ? "" : (pageNumber + 1).ToString("".PadLeft(suffixDigits, '0'));            
            if (SeparateFiles || IsMultiFrameTiff)
            {
            ...
            state = g.Save();
            g.FillRegion(Brushes.White, new Region(new RectangleF(0, FCurOriginY, width, height)));

            if (image == FBigImage)
                g.TranslateTransform(image.Width / 2 - width / 2 + page.LeftMargin * Units.Millimeters * zoomX, 
                    FCurOriginY + FPaddingNonSeparatePages + page.TopMargin * Units.Millimeters * zoomY);
            else
        ...
        protected override void ExportPageEnd(ReportPage page)
        {
            ...
            if (SeparateFiles || IsMultiFrameTiff)
                ...
                FCurOriginY += height + FPaddingNonSeparatePages * 2;
            FFirstPage = false;
            pageNumber++;
        }
