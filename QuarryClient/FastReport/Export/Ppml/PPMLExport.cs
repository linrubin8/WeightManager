...
namespace FastReport.Export.Ppml
{
    ...
    /// </summary>
    public class PPMLExport : ExportBase
    {
        ...
        private PPMLImageFormat imageFormat;
        ...
        /// </summary>
        public PPMLImageFormat ImageFormat
        {
            ...
            if (pictures)
            {
                ...
                using (System.Drawing.Image image = new Bitmap((int)obj.Width, (int)obj.Height))
                {
                    using (Graphics g = Graphics.FromImage(image))
                    {
                        ...
                        {
                            if (imageFormat == PPMLImageFormat.Jpeg)
                                g.Clear(Color.White);
                ...
                if (!string.IsNullOrEmpty(path))
                    ppml.AddImage(imageFileName, format.ToString().ToLower(), (obj.AbsLeft + pageLeftMargin) * 0.75f, (obj.AbsTop + pageTopMargin) * 0.75f, obj.Width * 0.75f, obj.Height * 0.75f);
                else
                    ppml.AddImage(imageFileName, format.ToString().ToLower(), imageFileName + "_" + Convert.ToString(img_nbr), (obj.AbsLeft + pageLeftMargin) * 0.75f, (obj.AbsTop + pageTopMargin) * 0.75f, obj.Width * 0.75f, obj.Height * 0.75f);
                img_nbr++;
        ...
        protected override void Start()
        {
            ...
            using (ReportPage page = GetPage(0))
            {
                ...
                ppml.TextInCurves = FTextInCurves;
            }
        }
        ...
        {
            using (PPMLExportForm form = new PPMLExportForm())
            {
                form.Init(this);
        ...
        public PPMLExport()
        {
            ...
            pictures = true;
            quality = 90;
            imageFormat = PPMLImageFormat.Png;
